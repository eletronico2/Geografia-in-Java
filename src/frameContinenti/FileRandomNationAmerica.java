...
class FileRandomNationAmerica {
    public String imageFolder = "src/images/flagsSudAmerica/";
    
    public Nation getRandomNation() throws IOException {
        File file = new File("src/file/sudamericanation.txt");
        if (!file.exists()) {
            throw new IOException("Il file 'sudamericanation.txt' non esiste.");
        }
